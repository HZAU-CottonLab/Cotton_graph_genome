...
LastEditors: zpliu
LastEditTime: 2023-10-20 20:13:36
@param: 
'''
import pandas as pd 
import sys 
...
syntenicGeneInfo=[]
sampleOrder=[
       'J85', 'DC001', 'DC053', 'DC086',
       'DC089', 'DC097', 'DC113', 'DC119', 'DC133', 'DC146', 'DC151', 'DC165',
       'DC175', 'DC212', 'J98'
    ]
...
syntenicGeneInfo=pd.DataFrame(syntenicGeneInfo,
   columns=   [
        'windowsType','J85',  'DC001', 'DC053',
         'DC086', 'DC089', 'DC097', 'DC113', 'DC119', 'DC133', 'DC146', 'DC151',
         'DC165', 'DC175', 'DC212', 'J98', 'orthId',
         'J85_gene','DC001_gene','DC053_gene','DC086_gene',
         'DC089_gene','DC097_gene','DC113_gene','DC119_gene','DC133_gene',
      'DC146_gene','DC151_gene','DC165_gene','DC175_gene','DC212_gene',
      'J98_gene'
   ]
 )
