...
LastEditors: zpliu
LastEditTime: 2023-08-23 20:17:07
@param: 
'''
import pandas as pd 
import sys
...
SV_info=pd.read_csv(
        "/public/home/zpliu/Pan-genome/SV_parallele_V2/superPan/At_genotype_V2/At_SV_merge_info.txt",
...
for window,windowData in intersectedData.groupby(['windowChr','windowStart','windowEnd']):
    ...
    queryChr=window[0][5:]
    halFile='/public/home/zpliu/Pan-genome/Cactus-Pan/AD_genomes/A_genome_V2/panGenome-{}/{}.full.hal'.format(
        queryChr,queryChr
    )
