...
LastEditors: zpliu
LastEditTime: 2023-10-20 20:20:47
@param: 
'''
import pandas as pd 
import sys 
...
for sample in AD1_sampleInfo[0].values:
    geneOrthoBedFile[sample]=geneOrthoBedFile.get(sample, 
        pd.read_csv(
                "/public/home/zpliu/Pan-genome/SV_parallele_V2/convergnce_divergence/JCVI/A2_At_Dt_D5/{}.At_gene_orthogroup.txt".format(
                    sample
                ),
                header=None,index_col=None,sep="\t"
            )
...
syntenicGeneInfo=[]
sampleOrder=[ 
        'HC04', 'HC15', 'HW03', 'HW05', 'HW06',
       'HW07', 'P01', 'P02', 'P04', 'P19', 'P20', 'TW007', 'TW013', 'TW026',
       'TW029', 'TW031', 'TW055', 'TW064', 'TW075', 'TW077', 'TW091', 'TW094',
       'TW100', 'TW134', 'XJ74', 'XZ142', 'ZY006', 'ZY10', 'ZY184', 'ZY236',
...
syntenicGeneInfo=pd.DataFrame(syntenicGeneInfo,
   columns=   [
         'windowsType','HC04','HC15', 'HW03', 'HW05', 'HW06',
         'HW07', 'P01', 'P02', 'P04', 'P19', 'P20', 'TW007', 'TW013', 'TW026',
         'TW029', 'TW031', 'TW055', 'TW064', 'TW075', 'TW077', 'TW091', 'TW094',
         'TW100', 'TW134', 'XJ74', 'XZ142', 'ZY006', 'ZY10', 'ZY184', 'ZY236',
         'ZY238', 'ZY354', 'ZY381', 'ZY384', 'ZY461','orthId',
         'HC04_gene','HC15_gene','HW03_gene','HW05_gene','HW06_gene','HW07_gene',
      'P01_gene','P02_gene','P04_gene','P19_gene','P20_gene','TW007_gene',
      'TW013_gene','TW026_gene','TW029_gene','TW031_gene','TW055_gene','TW064_gene',
      'TW075_gene','TW077_gene','TW091_gene','TW094_gene','TW100_gene','TW134_gene',
      'XJ74_gene','XZ142_gene','ZY006_gene','ZY10_gene','ZY184_gene','ZY236_gene',
      'ZY238_gene','ZY354_gene','ZY381_gene','ZY384_gene','ZY461_gene'
   ]
 )
