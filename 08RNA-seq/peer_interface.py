...
if __name__ == "__main__":
    ...
    parser.add_argument("-has_rownames", help="with rowNames ")
    parser.add_argument("-has_header", help="with header")
    ...
    读取文件时，判断是否存在行名和列名
    '''
    # print(args.has_rownames,args.has_header)
    # if args.has_header=='1':
    #     expr = SP.loadtxt(args.f, delimiter=',', skiprows=1)
    # else:
    #     expr = SP.loadtxt(args.f, delimiter=',')
    # if args.has_rownames=='1':
    #     expr = expr[:, 1:]
    # else:
    #     pass
    expr = SP.loadtxt(args.f, delimiter=',')
